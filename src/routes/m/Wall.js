...
import missing from '../../assets/wall.jpg';
...
function Wall({dispatch, form, list, loading}) {
...
function mapStateToProps(state) {
  ...
  return {
    list,
    loading: state.loading.models.wall
  };
}

export default connect(mapStateToProps)(createForm()(Wall));
